...
//                (By.className("container"));
    ...
    public void iLCarroTest() {
        ...
        WebElement btnTermOfUse = driver.findElement(By.
                cssSelector("[href='/terms-of-use']"));
        btnTermOfUse.click();
        pause(5);

        WebElement btnSignUp = driver.findElement(By.
                cssSelector("div.header a.navigation-link:nth-child(5)"));
        btnSignUp.click();
        pause(5);

        WebElement btnLogIn = driver.findElement(By.
                cssSelector("div.header a.navigation-link:last-child"));
        btnLogIn.click();
        pause(5);
